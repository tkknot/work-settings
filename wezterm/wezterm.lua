...
-- このパレットは Ctrl+Shift+B の背景色にも流用されるため、
-- ・白文字（format-tab-title の Foreground 固定値 #ffffff）とのコントラスト比 4.5 以上
-- ・ウィンドウ全面の背景に敷いても目が痛くならない暗さ
-- の2条件を満たす色だけを追加する。既存項目の並びは変えず末尾に足すこと（選択位置が変わるため）
local tab_color_choices = {
	...
	{ id = "#546e7a", label = "グレー" },
	{ id = "#1a237e", label = "ネイビー" },
	{ id = "#0277bd", label = "スカイ" },
	{ id = "#00838f", label = "シアン" },
	{ id = "#557a1a", label = "ライム" },
	{ id = "#946200", label = "ゴールド" },
